...
/*============ Scroll Up Activation ============*/
    $.scrollUp({
        scrollText: '<span style="font-size: 30px; color: #ffffff;"><i class="far fa-chevron-up"></i></span>',
        easingType: 'linear',
        scrollSpeed: 900,
        animation: 'slide'
    });
...
/*=============  Slider Activation  ==============*/
    $('.slide__activation').owlCarousel({
        ...
        autoplayTimeout: 10000,
        items:1,
        navText: ['<span style="font-size: 60px; color: #4fbdba; position: relative; top: -15px;"><i class="fas fa-chevron-left"></i></span>', '<span style="font-size: 60px; color: #4fbdba; position: relative; top: -15px;"><i class="fas fa-chevron-right"></i></span>' ],
        dots: false,
        lazyLoad: true,
        responsive:{
        0:{
