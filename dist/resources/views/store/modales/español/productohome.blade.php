  @foreach($productos as $producto)
    ...
    <div class="modal-quick-view modal fade" id="quick-view{{$producto->id}}" tabindex="-1">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title product-title">
              <a href="{{ route('product-detail' , $producto->slug) }}" data-toggle="tooltip" data-placement="right" title="Ver el producto">{{$producto->nombre}}
                <span style="font-size: 1.2em; color: #4fbdba; position: relative; top: 4px;">
                ...
                <div class="cz-product-gallery">
                  <div class="cz-preview order-sm-2">
                    <div class="cz-preview-item active" id="first">
                      <img class="cz-image-zoom" src="img/shop/single/gallery/01.jpg" data-zoom="img/shop/single/gallery/01.jpg" alt="Product image">
              ...
              <div class="col-lg-5 pt-4 pt-lg-0 cz-image-zoom-pane">
                <div class="product-details ml-auto pb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <del class="text-muted font-size-lg mr-3">{{$producto->price_dolar}}</del>
