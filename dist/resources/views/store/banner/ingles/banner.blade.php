...
<section class="cz-carousel cz-controls-lg mb-4 mb-lg-5">
      <div class="tns-outer" id="tns2-ow"><div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="tns2"><i class="czi-arrow-left"></i></button><button type="button" data-controls="next" tabindex="-1" aria-controls="tns2"><i class="czi-arrow-right"></i></button></div><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">1</span>  of 3</div><div class="tns-inner" id="tns2-iw"><div class="cz-carousel-inner tns-slider tns-gallery tns-subpixel tns-calc tns-horizontal" data-carousel-options="{&quot;mode&quot;: &quot;gallery&quot;, &quot;responsive&quot;: {&quot;0&quot;:{&quot;nav&quot;:true, &quot;controls&quot;: false},&quot;992&quot;:{&quot;nav&quot;:false, &quot;controls&quot;: true}}}" id="tns2">
        <!-- Item-->
        <div class="px-lg-5 tns-item tns-fadeIn tns-slide-active" style="background-color: rgb(245, 177, 176); left: 0%;" id="tns2-item0">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4">

          	<img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="{{ asset('img/banner/04.jpg') }}" alt="Women Sportswear">
        ...
        <!-- Item-->
        <div class="px-lg-5 tns-item tns-normal" style="background-color: #3aafd2;" id="tns2-item1" aria-hidden="true" tabindex="-1">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4">

          	<img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="{{ asset('img/banner/04.jpg') }}" alt="Summer Collection">
        ...
        <!-- Item-->
        <div class="px-lg-5 tns-item tns-normal" style="background-color: #eba170;" id="tns2-item2" aria-hidden="true" tabindex="-1">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4">

          	<img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="{{ asset('img/banner/04.jpg') }}" alt="Men Accessories">
      ...
      <div class="px-lg-5 tns-item tns-normal" style="background-color: #f5b1b0;" aria-hidden="true" tabindex="-1">
