          ...
          @if(session('cart'))
            @foreach(session('cart') as $id => $details)
	          ...
	          <div class="d-sm-flex justify-content-between align-items-center my-4 pb-3 border-bottom">
	            <div class="media media-ie-fix d-block d-sm-flex align-items-center text-center text-sm-left"><a class="d-inline-block mx-auto mr-sm-4" href="shop-single-v1.html" style="width: 10rem;"><img src="img/shop/cart/01.jpg" alt="Product"></a>
	              <div class="media-body pt-2">
	                <h3 class="product-title font-size-base mb-2"><a href="shop-single-v1.html">{{ $details['name'] }}</a></h3>
	                ...
	                <div class="font-size-lg text-accent pt-2">${{ $details['price_dolar'] }}<small>00</small></div>
	              </div>
	            </div>

	            <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 9rem;">
	              <div class="form-group mb-0">
	                <label class="font-weight-medium" for="quantity1">{{ number_format($details['price_dolar'] *  $details['quantity'],2) }}</label>

	               <!--  <input class="form-control" type="number" id="quantity1_{{$id}}" value="{{ $details['quantity'] }}"> -->
	            ...
	            <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 9rem;">
	              <div class="form-group mb-0">
	                ...
	                <input min="1" class="form-control" type="number" id="quantity1_{{$id}}" value="{{ $details['quantity'] }}">
